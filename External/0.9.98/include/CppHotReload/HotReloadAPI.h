...
extern "C"
{
	...
	namespace CppHotReload
	{
		namespace Configuration
		{
			...
			typedef bool (CPP_HOT_RELOAD_DECLARE* EXEC_BAT_FUNCTION)  (const char* const executablePath, const char* const workingDir, const char*& outputLog);
		...
		typedef void  (CPP_HOT_RELOAD_DECLARE* CPP_HOT_RELOAD_CALLBACK_PARSING_FILE_PROGRESS)(const size_t currentNumFile, const size_t totalNumFiles, const char* const fileName);
		...
		typedef void  (CPP_HOT_RELOAD_DECLARE* CPP_HOT_RELOAD_CALLBACK_WILL_COMPILE_FILE)   (const char* const filePath, const char*& additionalFilesToCompile);
		...
		CPP_HOT_RELOAD_API void CPP_HOT_RELOAD_DECLARE CreateWithConfigurationString(const char**   scriptDirs,
																					unsigned short scriptDirsSize,
																					const char* const includeFileString,
																					Configuration::EnvironmentVariable environmentVariables[], unsigned short environmentVariablesSize,
																					Configuration::CallBacks callbacksOptions[], unsigned short callbacksOptionsSize,
																					Configuration::Option configurationOptions[], unsigned short configurationOptionsSize,
																					Compiler::Option compilerOptions[], unsigned short compilerOptionsSize,
		...
		CPP_HOT_RELOAD_API bool CPP_HOT_RELOAD_DECLARE HasToPurge(void);
