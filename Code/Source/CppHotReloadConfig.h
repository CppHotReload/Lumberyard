...
#define LUMBERYARD_GAME_PATH			LUMBERYARD_CPP_HOT_RELOAD_DIR "/Code/Source/Test/"		// For prototype testing
//
// Build configuration
//
#ifdef _DEBUG
...
#	define LUMBERYARD_BIN_TEMP_PATH		LUMBERYARD_DEV_DIR "BinTemp/win_x64_vs2017_debug/"		// Where is the PCH file
#else
#	define CPP_HOT_RELOAD_CONFIGURATION "Release"
#	define CPP_HOT_RELOAD_IS_DEBUG 0
#	define LUMBERYARD_BIN_TEMP_PATH		LUMBERYARD_DEV_DIR "BinTemp/win_x64_vs2017_profile/"		// Where is the PCH file
#endif
//
// Locate pch 
//
#define LUMBERYARD_GAME_PCH_PATH LUMBERYARD_BIN_TEMP_PATH LUMBERYARD_GAME_NAME "/Code/Source/"
...
#	else
#		define CPP_HOT_RELOAD_FORCE_COMPILE_OPTIONS CPP_HOT_RELOAD_PCH_OPTIONS R"(/MD /bigobj /nologo /W3 /WX- /MP /Gy /GF /Gm- /fp:fast /Zc:wchar_t /Zc:forScope /Gd /Zc:inline /wd4530 /wd4577 /wd4005 /wd4240 /FS /Ox /Ob2 /Ot /Oi /Oy- /GR- /MD /Z7 )"
